...
```bash
$ cortex install mycolorify --save
```
...
```js
var mycolorify = require('mycolorify');
```
...
Creates a new mycolorify instance.
...
### mycolorify.&lt;method-name&gt;(arguments)
